-- =============================================
-- MINUME XVII - Esquema + datos seed
-- Para Supabase MySQL / MySQL externo
-- IMPORTANTE: NO incluye CREATE DATABASE / USE
-- porque la base de datos ya la crea el proveedor.
-- Ejecuta este archivo en tu base de datos MySQL.
-- =============================================
...
INSERT INTO users (email, password, full_name, role, commission_id, is_active) VALUES
('superadmin@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Superadmin MINUME XVII', 'superadmin', NULL, TRUE),
('secretaria@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Secretaria de Control y Calidad', 'secretaria', NULL, TRUE),
('mesa.educacion@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Mesa Directiva - Educacion', 'mesa', 1, TRUE),
('mesa.cooperacion@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Mesa Directiva - Cooperacion', 'mesa', 2, TRUE),
('delegado1@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Ana Maria Lopez', 'delegado', 1, TRUE),
('delegado2@minume-xvii.edu.do', '$2a$12$TyswpA71t9/OiFwiAn40ieiwCVzXd9jsjs.HCBbqK2KuWLmgt9B8i', 'Carlos Perez', 'delegado', 1, TRUE)
